...
<html> <!-- Definition des Stammverzeichnises -->
    ...
    <body> <!-- Definition des Bodybereiches -->
        ...
        <script>
		 ...
		 <!-- Das audio Tag ist seit HTML5 vorhanden -->
    ...
    <center><h2>Temperatur-Projekt</h2>
        ...
        <ol>
            <li>Das Kompilieren von C-Sourcecode erstellt den Treiber für einen Temperatursensor auf meinem Pi bzgl. Grad(in Celsius) und Sättigungsdampfdruck meiner Wohnung.</li>
            ...
            <li>Über das Menu können die Temperatur-und Sättigungsdampfdruckwerte abgerufen werden, sowohl grafisch als auch tabellarisch.</li>
            <li><s>Da der CronJob doppelt aufgerufen wird, sollten die Werte über den Adminberich bereinigt werden!</s> Im Adminbereich können Werte auch gelöscht und Messfehler beseitigt werden.</li>
        </ol>
        <?php
		//Lese die Anzahl aller vorhandenen Records aus
